...
import { AlternativasEvaluacionSchema, alternativaEvaluacionFields } from "../add-alternativas-evaluacion";
import { AlternativaEvaluacionTableItem, alternativaEvaluacionColumns, alternativaEvaluacionParams } from "./columns";
...
export default function AlternativaEvaluacionTable({ data }:AlternativaEvaluacionTableProps) {
	...
	return (
		<section className=''>
			<DataTable columns={alternativaEvaluacionColumns} data={alternativasEvaluaciones} />
            <UpdateAlternativaEvaluacion alternativasEvaluaciones={alternativasEvaluaciones} />
            <DeactivateAlternativaEvaluacion alternativasEvaluaciones={alternativasEvaluaciones} />
		</section>
	);
}

function UpdateAlternativaEvaluacion({ alternativasEvaluaciones }: { alternativasEvaluaciones: AlternativasEvaluacionSchema[] }) {
	...
	const selectedAlternativaEvaluacion = alternativasEvaluaciones.find(i => i.id === alternativaEvaluacionId);
...
function DeactivateAlternativaEvaluacion({ alternativasEvaluaciones }: { alternativasEvaluaciones: AlternativasEvaluacionSchema[] }) {
	const router = useRouter();
	const searchParams = useSearchParams();
	const pathname = usePathname();
	...
	return (
		<DeleteModal
			...
			onDelete={() => console.log('falta implementar lógica de delete', selectedAlternativaEvaluacion)}
			disabled={mutation.isPending}
