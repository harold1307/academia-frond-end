...
import { alternativaEvaluacionColumns, AlternativaEvaluacionTableItem } from "./columns";

interface DataTableProps {
	columns: typeof alternativaEvaluacionColumns;
	data: AlternativaEvaluacionTableItem[];
}
