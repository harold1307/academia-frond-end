...
export default function AddPrograma() {
	...
	return (
		<section>
			<h1 className='text-2xl font-semibold'>Costos generales</h1>
			<div className="flex flex-row gap-2 items-center">
				<Dialog open={open} onOpenChange={setOpen}>
					...
					<DialogContent className='max-h-[80%] max-w-xs overflow-y-scroll sm:max-w-[425px] md:max-w-2xl'>
						<DialogHeader>
							<DialogTitle>Adicionar Costos</DialogTitle>
						</DialogHeader>
						<Form {...form}>
							<form
				...
				<SelectGroup>
					<Select>
						<SelectTrigger>SEDES</SelectTrigger>
						<SelectContent>
				...
				<SelectGroup>
					<Select>
						<SelectTrigger>MATERIAS</SelectTrigger>
						<SelectContent>
				...
				<SelectGroup>
					<Select>
						<SelectTrigger>MODALIDAD</SelectTrigger>
						<SelectContent>
				...
				<SelectGroup>
					<Select>
						<SelectTrigger>DETALLES</SelectTrigger>
						<SelectContent>
							<SelectItem value='1'>INSCRITOS</SelectItem>
							<SelectItem value='2'>NO INSCRITOS</SelectItem>
							<SelectItem value='3'>DESCARTADOS</SelectItem>
				...
				<SelectGroup>
					<Select>
						<SelectTrigger>SESIÓN</SelectTrigger>
						<SelectContent>
							<SelectItem value='1'>INSCRITOS</SelectItem>
							<SelectItem value='2'>NO INSCRITOS</SelectItem>
							<SelectItem value='3'>DESCARTADOS</SelectItem>
				...
				<SelectGroup>
					<Select>
						<SelectTrigger>TIPO DE CALCULO</SelectTrigger>
						<SelectContent>
							<SelectItem value='1'>INSCRITOS</SelectItem>
							<SelectItem value='2'>NO INSCRITOS</SelectItem>
							<SelectItem value='3'>DESCARTADOS</SelectItem>
