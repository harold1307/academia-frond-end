...
import {
	NivelesAcademicosSchema,
	nivelesAcademicosTableItem,
	nivelesAcademicosColumns,
	horariosParams,
} from "./columns";
...
interface NivelesAcademicosTableProps {
	data: NivelesAcademicosSchema[];
}

export default function NivelesTable({ data }: NivelesAcademicosTableProps) {
	...
	return (
		<section className=''>
			<DataTable columns={nivelesAcademicosColumns} data={horarios} />
			<SendMessage horarios={horarios} />
		</section>
	);
}

function SendMessage({ horarios }: { horarios: NivelesAcademicosSchema[] }) {
