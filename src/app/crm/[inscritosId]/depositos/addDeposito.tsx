...
export default function AddDeposito() {
	...
	return (
		<section>
			<h1 className='text-2xl font-semibold'>Depósitos o transferencias</h1>
			<Dialog open={open} onOpenChange={setOpen}>
				...
				<DialogContent className='max-h-[80%] max-w-xs overflow-y-scroll sm:max-w-[425px] md:max-w-2xl'>
					<DialogHeader>
						<DialogTitle>Adicionar deposito o transferencia</DialogTitle>
					</DialogHeader>
					<Form {...form}>
						<form
...
const fields = [
	...
	},
	{
		name: "motivo",
		inputType: "textarea",
		label: "Motivo e informacion del titular de la cuenta",
	},
	{ name: "deposito", inputType: "toggle", label: "Deposito" },
	{
		name: "valor",
		inputType: "number",
		label: "Valor",
